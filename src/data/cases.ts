...
export const CASES: CaseItem[] = [
  ...
  {
    id: 'c-20260803-xrp-staking-fraud',
    title: "'리플 맡기면 매달 이자' 가짜 사이트로 123억 뜯은 사기단 검거",
    summary:
      '리플(XRP)을 맡기면 매달 이자를 지급한다고 속여 71명으로부터 123억원을 가로챈 사기단이 경찰에 붙잡혔다. 이들은 대역배우까지 고용해 가짜 투자 사이트를 실재하는 회사처럼 꾸민 것으로 드러났다.',
    content:
      '서울경찰청 사이버수사대는 가짜 리플 스테이킹 사이트를 개설해 매달 1.5~1.8%의 수익을 준다고 속여 피해자 71명으로부터 리플 약 340만개, 원화로 123억원 상당을 가로챈 혐의로 A씨 등을 구속 송치했다고 밝혔다. 이들은 지난해 10월 가짜 투자 사이트를 만들고 대역 배우까지 동원해 실제 운영되는 회사인 것처럼 피해자들을 속인 것으로 조사됐다. 피해자 중에는 16억원을 잃은 사람도 있었으며, 해외로 도피한 핵심 공범에 대해서는 체포영장과 인터폴 적색수배가 내려졌다.',
    category: 'etc',
    region: '서울',
    date: '2026-08-03',
    source: '헤럴드경제',
    sourceUrl: 'https://biz.heraldcorp.com/article/10825825',
    likes: 350,
    comments: 61,
  },
  {
    id: 'c-20260803-stent-rebate-42b',
    title: "임상시험 명목 스텐트 리베이트 42억…대학병원 교수 6명 재판行",
    summary:
      "심혈관용 스텐트 제조업체가 '시판 후 임상시험' 제도를 악용해 전국 대학병원 교수들에게 42억원의 리베이트를 건넨 사실이 검찰에 적발됐다. 시술 1건당 최대 115만원을 연구비 명목으로 지급한 것으로 드러났다.",
    content:
      "서울서부지검 식품의약범죄조사부는 의료기기법 위반, 배임증재 등 혐의로 스텐트 판매업체와 대표, 전직 이사를 불구속 기소하고 리베이트를 받은 대학병원 교수 6명도 의료법 위반 혐의로 함께 재판에 넘겼다. 이 업체는 2016년 8월부터 지난해 9월까지 전국 53개 의료기관에 스텐트에 대한 '시판 후 임상시험'을 제안한 뒤 연구비 명목으로 시술 1건당 20만~115만원, 합계 약 42억원을 지급한 것으로 조사됐다. 검찰은 시판 후 임상시험 제도를 악용한 신종 리베이트 수법을 처음으로 적발한 사례라고 밝혔다.",
    category: 'etc',
    region: '전국',
    date: '2026-08-03',
    source: '머니투데이',
    sourceUrl: 'https://www.mt.co.kr/society/2026/07/30/2026073015072941333',
    likes: 260,
    comments: 47,
  },
  {
